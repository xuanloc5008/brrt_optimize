...
if("TRUE" STREQUAL "TRUE")
  set(path_finder_SOURCE_PREFIX /home/xuanloc/DACN/ICIT/brrt_optimize/src/path_finder)
  set(path_finder_DEVEL_PREFIX /home/xuanloc/DACN/ICIT/brrt_optimize/devel)
  ...
  set(path_finder_INSTALL_PREFIX /home/xuanloc/DACN/ICIT/brrt_optimize/install)
...
if(NOT "/home/xuanloc/DACN/ICIT/brrt_optimize/src/path_finder/include " STREQUAL " ")
  set(path_finder_INCLUDE_DIRS "")
  set(_include_dirs "/home/xuanloc/DACN/ICIT/brrt_optimize/src/path_finder/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'path_finder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xuanloc/DACN/ICIT/brrt_optimize/src/path_finder/${idir}'.  ${_report}")
    endif()
